...
export default function Hero() {
    return (
        <div className="my-10 lg:mt-20 mb-10 bg-indigo-500 rounded-lg p-5 text-white bg-opacity-60 dark:bg-opacity-40 border-4 border-indigo-800 shadow-lg backdrop-blur">
