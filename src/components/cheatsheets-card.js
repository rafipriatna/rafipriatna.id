    ...
    return (
        <li className='text-slate-800 pl-0 my-0'>
            <Link to={`/cheatsheets/` + node.fields.slug}
                key={node.id}
                className='flex w-full items-center border-l-2 border-indigo-300 py-1 pl-2 text-sm dark:text-gray-200 hover:text-indigo-600 no-underline hover:border-indigo-600 dark:hover:text-indigo-400 dark:border-slate-600 dark:hover:border-indigo-500'
                activeClassName='text-indigo-600 dark:text-indigo-400 border-l-2 border-indigo-600 dark:border-indigo-500 bg-indigo-200 bg-opacity-30 dark:bg-opacity-20'
            >
